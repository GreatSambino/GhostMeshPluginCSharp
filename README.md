...
- Unit outlines. In my tactics game, units are rendered again using a GhostMesh with an inverted-hull material. The base layer is then used as a stencil to cut out the center of the inverted-hull, leaving crisp outlines around highlighted units.  
